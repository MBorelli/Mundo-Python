...
def diminuir(preço=0, taxa=0, formato=False):
    '''
    -> Calcula a diminuição de determinado preço,
    retornando o resultado com ou sem formatação.
    :param preço: o preço que se quer reajustar.
    :param taxa: qual é a porcentagem de diminuição.
    :param formato: quer a saída formatada ou não.
    :return: o valor reajustado, com ou sem formato.
    '''
    res = preço - (preço * taxa/100)
...
def dobro(preço=0, formato=False):
    '''
    -> Calcula o dobro de determinado preço,
    retornando o resultado com ou sem formatação.
    :param preço: o preço que se quer reajustar.
    :param formato: quer a saída formatada ou não.
...
def metade(preço=0, formato=False):
    '''
    -> Calcula a metade de determinado preço,
    retornando o resultado com ou sem formatação.
    :param preço: o preço que se quer reajustar.
    :param formato: quer a saída formatada ou não.
    :return: o valor pela metade, com ou sem formato.
    '''
    res = preço / 2
    return res if not formato else moeda(res)
